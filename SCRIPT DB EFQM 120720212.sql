...
CREATE TABLE IF NOT EXISTS `efqm`.`entrada` (
  ...
  `estado_entrada` INT GENERATED ALWAYS AS (1) VIRTUAL,
  `usuario_ing` INT(11) NOT NULL,
  `fecha_ing` DATE NOT NULL,
  `usuario_mod` INT(11) NOT NULL,
  `fecha_mod` DATE NOT NULL,
...
CREATE TABLE IF NOT EXISTS `efqm`.`acta_asistentes` (
  ...
  `es_miembro_grupo` INT(11) NOT NULL,
...
-- Table `efqm`.`empleado`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `efqm`.`empleado` (
  `id_empleado` INT(11) NOT NULL AUTO_INCREMENT,
  `dni_empleado` VARCHAR(11) NOT NULL,
  `id_equipo_trabajo` INT NOT NULL,
  `id_cargo` INT NULL,
  `nombre_empleado` VARCHAR(255) NOT NULL,
  `apellido_empleado` VARCHAR(255) NULL,
...
-- Table `efqm`.`usuarios`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `efqm`.`usuarios` (
  `id_usuario` INT(11) NOT NULL AUTO_INCREMENT,
  `cedula_usuario` VARCHAR(10) NOT NULL,
  `pw_usuario` VARCHAR(10) NOT NULL,
  `nombre_usuario` VARCHAR(50) NOT NULL,
  `correo_usuario` VARCHAR(50) NOT NULL,
  `grupo_usuario` INT(11) NOT NULL,
  `foto` TEXT NOT NULL,
  `lider` TINYINT(1) NOT NULL,
  `usuario_impresion` VARCHAR(254) NOT NULL,
  `co_cargo` INT(11) NOT NULL,
  `co_institucion` INT(11) NOT NULL,
  `permiso_cronograma` INT(11) NOT NULL,
  `estado` INT(11) NOT NULL DEFAULT 1,
  PRIMARY KEY (`id_usuario`))
ENGINE = MyISAM
AUTO_INCREMENT = 908378971
DEFAULT CHARACTER SET = latin1;
