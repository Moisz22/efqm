...
CREATE TABLE IF NOT EXISTS `efqm`.`tipo_proceso` (
  ...
  `estado_tipo_proceso` INT NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `efqm`.`version` (
  ...
  `estado_version` INT NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `efqm`.`cargo` (
  ...
  `jefe_cargo` INT NULL DEFAULT 0 COMMENT 'Flag para identificar que cargo pertenecen a los jefes departamentales',
...
CREATE TABLE IF NOT EXISTS `efqm`.`actividad` (
  ...
  `estado_actividad` INT NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `efqm`.`subactividad` (
  ...
  `estado_subactividad` INT NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `efqm`.`tipo_documento` (
  ...
  `estado_tipo_documento` INT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `efqm`.`anexo_proceso` (
  ...
  `estado_documento` INT NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `efqm`.`entrada` (
  ...
  `estado_entrada` INT NOT NULL DEFAULT 1,
  `usuario_ing` INT(11) NOT NULL,
  `fecha_ing` DATE NOT NULL,
  `usuario_mod` INT(11) NOT NULL,
  `fecha_mod` DATE NOT NULL,
...
CREATE TABLE IF NOT EXISTS `efqm`.`frecuencia` (
  ...
  `estado_frecuencia` INT NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `efqm`.`equipo_trabajo` (
  ...
  `estado_equipo_trabajo` INT(11) NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `efqm`.`categoria_indicador` (
  ...
  `estado_categoria_indicador` INT NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `efqm`.`indicador_detalle` (
  ...
  `estado_indicador_detalle` INT(11) NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `efqm`.`politica` (
  ...
  `estado_politica` INT NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `efqm`.`lugar` (
  ...
  `estado_lugar` INT NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `efqm`.`acta` (
  ...
  `estado_acta` INT NOT NULL DEFAULT 1,
  `usuario_ing` INT(11) NOT NULL,
  `fecha_ing` DATE NOT NULL,
  `usuario_mod` INT(11) NOT NULL,
  `fecha_mod` DATE NOT NULL,
...
CREATE TABLE IF NOT EXISTS `efqm`.`persona` (
  ...
  `apellido_persona` VARCHAR(255) NULL,
  `impresion_persona` VARCHAR(255) NULL COMMENT 'Este campo sirve para mostrar el nombre de la persona en las actas con sus  títulos de tercer o cuarto nivel.',
  `flag_empleado` INT NOT NULL DEFAULT 1 COMMENT '1) Para empleado 0) Para persona externa',
  `estado_persona` INT NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `efqm`.`acta_asistentes` (
  ...
  `es_miembro_equipo` INT(11) NOT NULL,
  `fl_asistencia` INT(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `efqm`.`recurso` (
  ...
  `estado_recurso` INT(11) NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `efqm`.`control_cambio` (
  ...
  `descripcion_control` VARCHAR(255) NOT NULL,
  `estado_control` INT NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `efqm`.`anexo_acta` (
  ...
  `estado_anexo_acta` INT NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `efqm`.`recurso_proceso` (
  ...
  `id_proceso` INT(11) NOT NULL,
  `id_actividad` INT(11) NOT NULL,
  `estado_recurso` VARCHAR(1) NOT NULL DEFAULT 'A',
...
CREATE TABLE IF NOT EXISTS `efqm`.`usuario` (
  ...
  `acceso_usuario` INT(11) NOT NULL DEFAULT 1 COMMENT 'Sirve para habilitar el login',
